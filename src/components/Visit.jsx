function Visit() {
  return (
    <section className="bg-zinc-100 bg-cover bg-center flex items-center justify-center">
      <div className="flex flex-wrap container my-20 mx-10">
        <div className="flex lg:w-1/2 sm:h-1/2 mr-5 item-center">
          <iframe
        ...
        <div className="flex flex-col lg:w-1/2 sm:h-1/2 text-blue-950 ml-5 container">
