function Visit() {
  return (
    <section className="bg-zinc-100 bg-cover bg-center flex items-center justify-center">
      <div className="lg:flex-row sm:flex-col sm:items-center my-20 mx-10">
        <div className="flex-none lg:w-1/2 sm:h-1/2 mr-4">
          <iframe
        ...
        <div className="flex flex-col lg:w-1/2 sm:h-1/2 text-blue-950">
