...
import LoggedIn_Icon from "../assets/LoggedIn_Icon.png";
          ...
          <div className="relative inline-block text-left">
            <div>
              <button 
                ...
                className="text-white hover:bg-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2.5 py-2.5 text-center inline-flex items-center" 
                type="button"
              >
                <img
                src={LoggedIn_Icon} 
              ...
              <div id="dropdownHover" className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownHoverButton">
                  <li>
                    <a href="#" className="block px-4 py-2 text-blue-950 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Profile</a>
                  </li>
                  <li>
                    <a href="#" className="block px-4 py-2 text-blue-950 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">My Inquiries</a>
                  </li>
                  <li>
                    <a href="#" className="block px-4 py-2 text-blue-950 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Wishlist</a>
                  </li>
                  <li>
                    <a href="#" className="block px-4 py-2 text-red-500 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Sign out</a>
                  </li>
                </ul>
              </div>
              </div>
