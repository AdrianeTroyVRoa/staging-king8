...
export default function AdminHeader(){
    return(
        <header>
        <nav class=" border-gray-200 px-4 lg:px-6 py-2.5 bg-zinc-100">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="https://flowbite.com" class="flex items-center">
                    <img src={logo} class="mr-3 h-6 sm:h-9" alt="Mindanao King8 Logo" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap text-blue-950">MINDANAO KING8 PLASTICS</span>
                </a>
