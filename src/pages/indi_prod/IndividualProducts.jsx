      ...
      <div class="container flex mx-auto px-4 pt-20 p-20 w-1/4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p b-20">
                <img class="pl-6 w-full md:w-3/4 h-auto rounded-lg pr-4" src={pipes} alt="image description"/>
                  ...
                  <label for="countries" class="text-3xl font-bold leading-none tracking-tight text-red-geg dark:text-blue-950 mb-4 pl-5 pt-10">Quantity: </label>

                     <select id="Quantity" class="font-bold border-solid border-2 border-blue-950 text-blue-950 py-3 px-4 rounded-lg hover:bg-white ">
