                                                            ...
                                                            <form action="#" class="w-full" onSubmit={handleSend}>
                                                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <input type="text" name="firstname" id="product_name" value={addFormData().product_name}   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Type product name" required=""/>
                                                                        <div className="mt-4">
                                                                            <label for="brand" class="block mb-2 text-sm font-medium text-gray-900   ">Quantity</label>
                                                                            <input type="text" name="lastname" id="quantity" value={addFormData().quantity}   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Type quantity" required=""/>
                                                                        </div>
                                                                        <div className="mt-4">
                                                                            <label for="price" class="block mb-2 text-sm font-medium text-gray-900">Variations</label>
                                                                            <input type="text" name="employeeid" id="variations" value={addFormData().variations}   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Type product variants" required=""/>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <div className="sm:col-span-2">
                                                                        <label for="description" className="block mb-2 text-md font-medium text-blue-950">Description</label>
                                                                        <textarea id="description" value={addFormData().description}   rows="6" className="block p-2.5 w-full text-sm text-blue-950 bg-grey-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="Your description here" required=""></textarea>
                                                                    </div>
                                                        ...
                                                        <div class="modal-content flex justify-center items-center bg-zinc-100">
                                                            <form action="#" class="w-full" onSubmit={handleUpdate}>
                                                                <div class="grid gap-4 mb-4 md:grid-cols-2 sm:grid-cols-2">
                                                                    ...
                                                                    <div>
                                                                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">Product Name</label>
                                                                        <input type="text" name="firstname" id="first_name" value={updateForm().product_name} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Type product name" required=""/>
                                                                        <div className="mt-4">
                                                                            <label for="brand" class="block mb-2 text-sm font-medium text-gray-900   ">Quantity</label>
                                                                            <input type="text" name="lastname" id="last_name" value={updateForm().quantity} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Type quantity" required=""/>
                                                                        </div>
                                                                        <div className="mt-4">
                                                                            <label for="price" class="block mb-2 text-sm font-medium text-gray-900">Variations</label>
                                                                            <input type="text" name="employeeid" id="employee_id" value={updateForm().variations} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Type product variants" required=""/>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="sm:col-span-2">
                                                                        <label for="description" className="block mb-2 text-md font-medium text-blue-950">Description</label>
                                                                        <textarea id="description" rows="6" value={updateForm().description} className="block p-2.5 w-full text-sm text-blue-950 bg-grey-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="Your description here"></textarea>
                                                                    </div>
                                                                </div>
                                                                <div>
                                                                    ...
                                                                    <button onClick={openConfirmDelete} class="text-zinc-100 items-center bg-red-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2.5 ml-4 justify-center">
                                                                        Delete product
                                                                </button>
                                                                </div>
                                                            </form>
                                            ...
                                            {isConfirmModalOpen() && (
                                                                    <div className="fixed top-0 left-0 w-full h-full px-4 flex justify-center items-center">
                                                                        ...
                                                                        <div className="absolute h-40 w-96 shadow-lg p-4 mb-4 text-gray-800 border border-gray-300 rounded-lg bg-gray-50">
                                                                            ...
                                                                            <div class="mt-2 mb-4 text-sm">Do you wish to continue adding this product?</div>
                                                                            <div class="flex">
                                                                                <button onClick={()=> {closeConfirmAddWindow(); closeAddWindow();}} type="button" class="text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-xs px-3 py-1.5 me-2 text-center inline-flex items-center">Create</button>
                                                                                <button onClick={closeConfirmAddWindow} type="button" class="text-gray-800 bg-transparent border border-gray-800 hover:bg-gray-900 hover:text-white focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-xs px-3 py-1.5 text-center" data-dismiss-target="#alert-additional-content-2" aria-label="Close">Cancel</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                )}
                                                                {isConfirmEditOpen() && (
                                                                    <div className="fixed top-0 left-0 w-full h-full px-4 flex justify-center items-center">
                                                                        ...
                                                                        <div className="absolute h-40 w-96 shadow-lg p-4 mb-4 text-gray-800 border border-gray-300 rounded-lg bg-gray-50">
                                                                            ...
                                                                            <div class="mt-2 mb-4 text-sm">Do you wish to continue revising your changes?</div>
                                                                            <div class="flex">
                                                                                <button onClick={closeConfirmEdit } type="button" class="text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-xs px-3 py-1.5 me-2 text-center inline-flex items-center">Yes, Continue</button>
                                                                                <button onClick={closeConfirmEdit} type="button" class="text-gray-800 bg-transparent border border-gray-800 hover:bg-gray-900 hover:text-white focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-xs px-3 py-1.5 text-center" data-dismiss-target="#alert-additional-content-2" aria-label="Close">Cancel</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                )}
                                                                {isConfirmDeleteOpen() && (
                                                                    <div className="fixed top-0 left-0 w-full h-full px-4 flex justify-center items-center">
                                                                        ...
                                                                        <div className="absolute h-40 w-96 shadow-lg p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-red-50">
                                                                            ...
                                                                            <div class="mt-2 mb-4 text-sm">Do you wish to continue revising your changes?</div>
                                                                            <div class="flex">
                                                                                <button onClick={()=> {closeConfirmDelete(); closeEditWindow(); }} type="button" class="text-white bg-red-800 hover:bg-red-900 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xs px-3 py-1.5 me-2 text-center inline-flex items-center">Yes, Continue</button>
                                                                                <button onClick={closeConfirmDelete} type="button" class="text-red-800 bg-transparent border border-red-800 hover:bg-red-900 hover:text-white focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xs px-3 py-1.5 text-center" data-dismiss-target="#alert-additional-content-2" aria-label="Close">Cancel</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                )}
